...
func getMeal(_ mealName: String) -> Meal? {
...
func checkLog(_ mealName: String) -> [String: Any] {
    if let logDict = UserDefaults.standard.dictionary(forKey: mealName) {
        return logDict
    } else {
        return [String: Any]()
    }
