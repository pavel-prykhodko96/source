 ...
 */
var comp1: Computer? = Computer(ram: 20300, yearManufactured: 2000)
if let comp1_ = comp1 {
    print(comp1_.ram)
    print(comp1_.yearManufactured)
}

var comp2: Computer? = Computer(ram: -10, yearManufactured: 2000)
if let comp2_ = comp2 {
    print(comp2_.ram)
    print(comp2_.yearManufactured)
}
