...
sorry_letter = ("Sorry, " + removed_guest + ". I can't invite you to the dinner")
print(sorry_letter)
...
notify_remained = (guests[0] + ", you are still invited")
print(notify_remained)
notify_remained = (guests[1] + ", you are still invited")
print(notify_remained)
del guests[1]
del guests[0]
print(guests)
